    ...
    def add_new_switches():
        ...
        for device_data in all_devices:
            ...
            if device_serial not in created_entities:
                ...
                new_entities.append(
                    NexecurCameraStreamSwitch(
                        client, coordinator, entry, device_serial, device_data, alarm_version
                    )
                )
...
class NexecurCameraStreamSwitch(CoordinatorEntity, SwitchEntity):
    ...
    def __init__(
        ...
        self._attr_unique_id = f"nexecur_stream_switch_{self._identifier}_{device_serial}"
